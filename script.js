...
const categorias = {
    ...
    frutas: ['banana', 'maça', 'laranja', 'uva', 'pera', 'abacate', 'abacaxi', 'mamao'],
    profissoes: ['engenheiro', 'advogado', 'medico', 'professor', 'pescador', 'gari', 'bombeiro'],
    cores: ['amarelo', 'azul', 'laranja', 'roxo', 'vermelho', 'marrom', 'rosa', 'verde', 'cinza'],
    animais: ['papagaio', 'galo', 'cachorro', 'gato', 'galinha', 'cavalo', 'porco', 'coelho', 'tigre']
